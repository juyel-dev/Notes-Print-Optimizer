 ...
 * eliminated.
 *
 * CLIENT_STATIC_DIR points at whatever this build mode actually ships to the
...
const isExport = fs.existsSync(path.join(REPO_ROOT, 'out'));
const CLIENT_STATIC_DIR = isExport
